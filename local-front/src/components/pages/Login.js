        ...
        <form onSubmit={this.formSubmit} className="form-top-padding col-sm-6 offset-3">
          <div className="d-flex flex-column justify-content-center padding_20">
            ...
            <div className="form-group">
              ...
              <input value={username} onChange={this.userInput}
                type="text"
                name="username"
            ...
            <div className="form-group">
              ...
              <input value={password} onChange={this.passwordInput}
                type="password"
                name="password"
                className="form-control"
            ...
            <div>
              ...
              <p>
                Forgot password? <Link to="/passwords">Renew Here</Link>
              </p>
            </div>
            <button type="submit" className="btn btn-primary col-6 align-self-center">
              Submit
            </button>
          </div>
        </form>
